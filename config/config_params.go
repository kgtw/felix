...
type Config struct {
	...
	FailsafeInboundHostPorts  []ProtoPort `config:"port-list;tcp:0.0.0.0/0:22,udp:0.0.0.0/0:68,tcp:0.0.0.0/0:179,tcp:0.0.0.0/0:2379,tcp:0.0.0.0/0:2380,tcp:0.0.0.0/0:5473,tcp:0.0.0.0/0:6443,tcp:0.0.0.0/0:6666,tcp:0.0.0.0/0:6667;die-on-fail"`
	FailsafeOutboundHostPorts []ProtoPort `config:"port-list;udp:0.0.0.0/0:53,udp:0.0.0.0/0:67,tcp:0.0.0.0/0:179,tcp:0.0.0.0/0:2379,tcp:0.0.0.0/0:2380,tcp:0.0.0.0/0:5473,tcp:0.0.0.0/0:6443,tcp:0.0.0.0/0:6666,tcp:0.0.0.0/0:6667;die-on-fail"`
